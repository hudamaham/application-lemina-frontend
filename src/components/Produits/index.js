    ...
    <>
      <div class="app-content  ">
        ...
        <div class="app-content-header justify-content-end  fixed">
          <NavLink to={"new"}>
            {" "}
            <button class="app-content-headerButton">Ajouter Produit</button>
          </NavLink>
        </div>
          ...
          {produits.map((produit, position) => {
            return (
              <div class="products-row" key={position}>
                ...
                <div class="product-cell category">
                  <span class="cell-label">Unatite :</span>
                  {produit.uantite}
                </div>
                <div class="product-cell  ">
                  <span class="cell-label">Prix :</span>
                  <span class="status  ">{produit.prix}</span>
                </div>
