...
import commandes from "../data/data-commandes";
    ...
    <>
      <div class="app-content  ">
        ...
        <div class="app-content-header justify-content-end  fixed">
          <NavLink to={"new"}>
            <button class="app-content-headerButton">Ajouter Commandes</button>
          </NavLink>
        </div>
        ...
        >
          ...
          {commandes.map((commande, position) => {
            return (
              <div class="products-row" key={position}>
                ...
                <div class="product-cell category">
                  <span class="cell-label">Etat Commande :</span>
