...
import communes from "../data/data-communes";
    ...
    <>
      <div class="app-content  ">
        <div className="d-flex flex-row  justify-content-between mb-3">
          <h1 class="app-content-headerText">Communes</h1>
        ...
        <div class="app-content-header justify-content-end  fixed">
          <NavLink to={"new"}>
            {" "}
            <button class="app-content-headerButton">Ajouter Commune</button>
          </NavLink>
        </div>
          ...
          {communes.map((commune, position) => {
            return (
              <div class="products-row" key={position}>
                ...
                <div class="product-cell category">
                  <span class="cell-label">Nom Commune :</span>
                  {commune.nom_commune}
                </div>
                <div class="product-cell category">
                  <span class="cell-label">Surfaces Agricoles :</span>
                  {commune.surfaces_agricoles}
                </div>
                <div class="product-cell category">
                  <span class="cell-label">Semences :</span>
                  {commune.semences}
                </div>

                <div class="product-cell category">
                  <span class="cell-label">Outils Agricoles :</span>
                  {commune.outils_agricoles}
                </div>
              </div>
            );
          })}
