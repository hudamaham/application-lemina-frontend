...
import ligne_commandes from "../data/data-lignecommande";
    ...
    <>
      <div class="app-content  ">
        <div className="d-flex flex-row  justify-content-between mb-3">
          <h1 class="app-content-headerText">LigneCommande</h1>
        ...
        >
          ...
          {ligne_commandes.map((ligne_commande, position) => {
            return (
              <div class="products-row" key={position}>
                ...
                <div class="product-cell category">
                  <span class="cell-label">Quatite :</span>
                  {ligne_commande.quatite}
                </div>
                <div class="product-cell  ">
                  <span class="cell-label">Prix Total :</span>
                  <span class="status  ">{ligne_commande.prix_total}</span>
                </div>
                <div class="product-cell sales">
                  <span class="cell-label">Date Vente :</span>
                  {ligne_commande.date_vente}
                </div>
              </div>
            );
          })}
