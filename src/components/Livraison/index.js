...
import livraisons from "../data/data-livraison";
    ...
    <>
      <div class="app-content  ">
        <div className="d-flex flex-row  justify-content-between mb-3">
          <h1 class="app-content-headerText">Livraison </h1>
        ...
        <div class="app-content-header justify-content-end  fixed">
          <NavLink to={"new"}>
            {" "}
            <button class="app-content-headerButton">Ajouter Livraison</button>
          </NavLink>
        </div>
        ...
        >
          ...
          {livraisons.map((livraison, position) => {
            return (
              <div class="products-row" key={position}>
                ...
                <div class="product-cell  ">
                  <span class="cell-label">Numero de livraison :</span>
                  <span class="status  ">{livraison.num_livraison}</span>
                </div>
                <div class="product-cell sales">
                  <span class="cell-label">Date Livraison :</span>
